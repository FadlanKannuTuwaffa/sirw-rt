...
class FileUploadController extends BaseFileUploadController
{
    public function handle()
    {
        ...
        try {
            ...
            if ($exception->getStatusCode() === 401) {
                $this->logSignatureFailure($request, 'upload');
            }
    ...
    private function logSignatureFailure(Request $request, string $context): void
    {
        Log::warning("Livewire {$context} signature invalid after sync", [
